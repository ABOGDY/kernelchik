...
NTSTATUS driver_main(PDRIVER_OBJECT driver_object, PUNICODE_STRING registry_path) {
	...
	RtlInitUnicodeString(&device_name, L"\\Device\\Kernelchik");
	...
	RtlInitUnicodeString(&symbolic_link, L"\\DosDevices\\Kernelchik");
...
NTSTATUS DriverEntry() {
	debug_print(" [+] ez kernelll \n");

	UNICODE_STRING driver_name = {};
	RtlInitUnicodeString(&driver_name, L"\\Driver\\Kernelchik");
